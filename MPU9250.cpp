...
//  MadgwickQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f,  my,  mx, mz);
  ...
  if (delt_t > 5)
  {
    ...
    if(SerialDebug)
    {
      ...
      Serial.print("X-acceleration: "); Serial.print(1000*ax);
      Serial.print(" mg ");
      Serial.print("Y-acceleration: "); Serial.print(1000*ay);
      Serial.print(" mg ");
      Serial.print("Z-acceleration: "); Serial.print(1000*az);
      Serial.println(" mg ");

      // Print gyro values in degree/sec
      Serial.print("X-gyro rate: "); Serial.print(gx, 3);
      Serial.print(" degrees/sec ");
      Serial.print("Y-gyro rate: "); Serial.print(gy, 3);
      Serial.print(" degrees/sec ");
      Serial.print("Z-gyro rate: "); Serial.print(gz, 3);
      Serial.println(" degrees/sec");

      // Print mag values in degree/sec
      Serial.print("X-mag field: "); Serial.print(mx);
      Serial.print(" mG ");
      Serial.print("Y-mag field: "); Serial.print(my);
      Serial.print(" mG ");
      Serial.print("Z-mag field: "); Serial.print(mz);
      Serial.println(" mG");
      
      Serial.print("q0 = "); Serial.print(*getQ());
      Serial.print(" q1 = "); Serial.print(*(getQ() + 1));
      Serial.print(" q2 = "); Serial.print(*(getQ() + 2));
      Serial.print(" q3 = "); Serial.println(*(getQ() + 3));
...
void MPU9250::SendUDPMessage(){
  ...
  val_array[14] = pitch;
  val_array[15] = roll;
  val_array[16] = temperature;//(9.*(float) temperature/5. + 32., 2);
...
void MPU9250::serialPayloadPrint(float f) {
    byte * b = (byte *) &f;
    for(int i=0; i<4; i++) {
...
void MPU9250::updataBMPData(){
//  bme_count++;  
//  if(bme_count == 10)
//    bmeTemperature = bme.readTemperature();//bmp280 temperature
//  else if (bme_count == 20)
//    bmePressure = bme.readPressure();//(float)sumCount/sum; 
//  else if (bme_count == 30) {      
//    bmeAltitude = bme.readAltitude(1013.25);//altitude;
//    bme_count = 0;
//  }
  bmeTemperature = bme.readTemperature();//bmp280 temperature
  bmePressure = bme.readPressure();//(float)sumCount/sum; 
